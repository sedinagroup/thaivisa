...
const Navbar: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'Apply', href: '/apply', icon: FileCheck },
    { name: 'AI Document Checker', href: '/ai-document-checker', icon: FileCheck },
    { name: 'AI Trip Planner', href: '/ai-trip-planner', icon: Compass },
