    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(/thailand-background.png)'
          }}
        ></div>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Advanced AI-powered Thailand visa application process. Get document verification, travel planning, and expert guidance in one place.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20">
              ...
              <CardContent className="text-center">
                <CardDescription className="text-base">
                  Verify your documents instantly with our advanced AI technology
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl font-bold">Smart Trip Planner</CardTitle>
              </CardHeader>
              <CardContent className="text-center">
                <CardDescription className="text-base">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl opacity-90 mb-8">
            Join thousands of travelers who trust our AI-powered platform for their Thailand visa applications.
          </p>
